...
from restli.clients.restli.utils.encoder import encode
from typing import Dict, Any, Optional
from restli.common.errors import InvalidArgumentError
import re
...
def build_rest_url(
    resource_path: str, path_keys: Optional[Dict[str, Any]] = None, version_string=None, use_www: bool = False
) -> str:
    ...
    if use_www:
        base_url = constants.WWW_BASE_URL
